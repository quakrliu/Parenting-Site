...
slug: "children-internet-safety-2026"
lang: "en"
---
...
Nearly three in four parents surveyed by Common Sense Media said they worried an AI toy might say something "inappropriate, untrue, or unsafe" to their child. That concern is well-founded.

**What to do:**
- Before purchasing any AI toy, look up its privacy policy. Specifically ask: does it store voice recordings? Who receives the data? Is there a way to delete conversation history?
- The US PIRG publishes an annual "Trouble in Toyland" report — worth checking before holiday shopping.
- For younger children (under 6), consider whether an AI companion toy adds enough value to justify the risk.
...
New York's Stop Online Predators Act (SOPA), championed by Senator Andrew Gounardes and included in Governor Hochul's 2026 legislative agenda, takes a more direct approach. It would require platforms to:

- Verify user ages using commercially reasonable methods
- Default all minor accounts to private — strangers can't view profiles without a friend request
...
The enforcement mechanism puts responsibility on platforms, not families. If tech companies fail to take "reasonable steps" to prevent under-16 accounts, they face fines of up to approximately $50 million AUD. Parents and children won't be penalized.
...
One thing Screen Time doesn't do well: it doesn't filter content within apps like YouTube or Safari very granularly. For YouTube specifically, YouTube Kids is a better solution for children under 10.

### Google Family Link (Android, Chromebook)

Family Link is Google's equivalent for Android devices. It lets you:
