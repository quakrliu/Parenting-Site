---
title: "Teaching Emotions to Preschoolers: 5 Activities That Actually Work (From a Dad Who Struggled)"
description: "A dad's honest guide to teaching preschoolers about emotions using an emotion wheel, role-play, and picture books — backed by research, tested at home."
pubDate: "2026-05-02"
tags: ["emotional intelligence", "preschoolers", "positive parenting", "4 year old", "emotions"]
lang: "en"
author: "Ethan Moore"
...
My [bedtime reading routine](/en/blog/bedtime-reading-benefits-empathy-creativity-en) now includes a question after every book: "How do you think [character] felt when that happened?" Not "what happened" — feelings specifically.
...
Short answer: [when kids understand their emotions](/en/blog/4-year-old-power-struggles-en), they meltdown less — and recover faster when they do.
...
**How do I start teaching emotions to a preschooler who doesn't seem interested?**
Start through play, not conversation. The mirror game and emotion wheel work well because they feel like games, not lessons. Follow your child's lead — if they don't want to engage, drop it and try again later. Consistency over a few weeks matters more than any single session.

**My three-year-old hits when he's upset instead of using words. Is emotion coaching relevant?**
Yes — especially for him. Hitting is almost always a communication failure. He doesn't have the words yet. Emotion coaching builds the vocabulary that eventually replaces the hitting. Expect the process to take weeks to months, not days.

**What's the difference between validating feelings and excusing bad behavior?**
Validation means acknowledging the feeling, not approving the action. "I can see you're really angry" doesn't mean "it's okay to throw toys." After the feeling is named and acknowledged, you address the behavior: "Throwing hurts people. When you're that angry, you can hit this pillow instead."

**Should I use an emotion wheel with my two-year-old?**
A simplified version, yes. Use pictures/faces rather than words, and stick to four core emotions: happy, sad, angry, scared. Two-year-olds can absolutely start learning to point to how they feel, even before they have the words.

**How long until I see results from emotion coaching?**
Real talk: four to eight weeks of consistent practice before you notice behavioral changes. Language acquisition for emotions takes repetition, the same way it does for any other vocabulary. Don't quit after one rough week.

<script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How do I start teaching emotions to a preschooler who doesn't seem interested?","acceptedAnswer":{"@type":"Answer","text":"Start through play, not conversation. The mirror game and emotion wheel work well because they feel like games, not lessons. Follow your child's lead — if they don't want to engage, drop it and try again later. Consistency over a few weeks matters more than any single session."}},{"@type":"Question","name":"My three-year-old hits when he's upset instead of using words. Is emotion coaching relevant?","acceptedAnswer":{"@type":"Answer","text":"Yes — especially for him. Hitting is almost always a communication failure. He doesn't have the words yet. Emotion coaching builds the vocabulary that eventually replaces the hitting. Expect the process to take weeks to months, not days."}},{"@type":"Question","name":"What's the difference between validating feelings and excusing bad behavior?","acceptedAnswer":{"@type":"Answer","text":"Validation means acknowledging the feeling, not approving the action. 'I can see you're really angry' doesn't mean 'it's okay to throw toys.' After the feeling is named and acknowledged, you address the behavior: 'Throwing hurts people. When you're that angry, you can hit this pillow instead.'"}},{"@type":"Question","name":"Should I use an emotion wheel with my two-year-old?","acceptedAnswer":{"@type":"Answer","text":"A simplified version, yes. Use pictures/faces rather than words, and stick to four core emotions: happy, sad, angry, scared. Two-year-olds can absolutely start learning to point to how they feel, even before they have the words."}},{"@type":"Question","name":"How long until I see results from emotion coaching?","acceptedAnswer":{"@type":"Answer","text":"Real talk: four to eight weeks of consistent practice before you notice behavioral changes. Language acquisition for emotions takes repetition, the same way it does for any other vocabulary. Don't quit after one rough week."}}]}
</script>
...
**[How to Talk So Little Kids Will Listen](https://www.amazon.com/dp/1501131656?tag=bloompath-20)** by Joanna Faber and Julie King — The most practical emotion coaching book I've found. Every chapter is a specific scenario. I've dog-eared half the pages.

**[Good Inside](https://www.amazon.com/dp/0063159481?tag=bloompath-20)** by Dr. Becky Kennedy — Dr. Becky reframes everything: kids aren't manipulative, they're struggling. That one mental shift changes how you respond to every meltdown.

**[The Whole-Brain Child](https://www.amazon.com/dp/0553386697?tag=bloompath-20)** by Daniel J. Siegel and Tina Payne Bryson — The neuroscience behind why emotion coaching works, explained in a way that doesn't require a PhD. The "connect then redirect" framework is now how I approach every hard moment.
