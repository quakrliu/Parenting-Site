...
def create_og_image(title, output_path, lang="en"):
    ...
    max_chars = 18 if lang == "zh" else 38
...
create_og_image(
    "My Kid Screamed for 20 Minutes Every Time I Turned Off the TV",
    "/home/user/Parenting-Site/public/og/toddler-screen-time-ending-meltdown-en.png",
    lang="en"
)

create_og_image(
    "孩子吃飯吃到快八點，每天都是消耗戰",
    "/home/user/Parenting-Site/public/og/toddler-slow-eater-dinner-drags-on-zh.png",
    lang="zh"
)
